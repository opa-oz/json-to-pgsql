...
snapshots['test_scheme_advanced 1'] = '''CREATE TABLE IF NOT EXISTS "anime_english"
(
...
snapshots['test_scheme_advanced 10'] = '''CREATE TABLE IF NOT EXISTS "anime_studios_m2m"
(
\t"id"          serial   UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_advanced 11'] = '''CREATE TABLE IF NOT EXISTS "anime_videos_m2m"
(
\t"id"         serial   UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_advanced 12'] = '''CREATE TABLE IF NOT EXISTS "anime_screenshots_m2m"
(
\t"id"              serial  UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_advanced 13'] = '''CREATE TABLE IF NOT EXISTS "anime_image"
(
\t"id"       serial  UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_advanced 14'] = '''CREATE TABLE IF NOT EXISTS "anime_rates_statuses_stats"
(
\t"id"    serial   UNIQUE PRIMARY KEY NOT NULL,
\t"name"  text     NOT NULL,
...
snapshots['test_scheme_advanced 15'] = '''CREATE TABLE IF NOT EXISTS "anime_genres"
(
...
snapshots['test_scheme_advanced 16'] = '''CREATE TABLE IF NOT EXISTS "anime_studios"
(
\t"id"            integer  UNIQUE PRIMARY KEY NOT NULL,
\t"name"          text     NOT NULL,
...
snapshots['test_scheme_advanced 17'] = '''CREATE TABLE IF NOT EXISTS "anime_screenshots"
(
\t"id"       serial  UNIQUE PRIMARY KEY NOT NULL,
\t"original" text    NOT NULL,
\t"preview"  text    NOT NULL
...
snapshots['test_scheme_advanced 18'] = '''CREATE TABLE IF NOT EXISTS "anime_rates_scores_stats"
(
\t"id"    serial   UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_advanced 19'] = '''CREATE TABLE IF NOT EXISTS "anime_videos"
(
\t"id"         integer  UNIQUE PRIMARY KEY NOT NULL,
\t"url"        text     NOT NULL,
...
snapshots['test_scheme_advanced 2'] = '''CREATE TABLE IF NOT EXISTS "anime_japanese"
(
\t"id"       serial  UNIQUE PRIMARY KEY NOT NULL,
\t"japanese" text   
) with (oids = false);
...
snapshots['test_scheme_advanced 20'] = '''CREATE TABLE IF NOT EXISTS "anime"
(
\t"id"                   integer  UNIQUE PRIMARY KEY NOT NULL,
\t"name"                 text     NOT NULL,
\t"russian"              text     NOT NULL,
...
snapshots['test_scheme_advanced 3'] = '''CREATE TABLE IF NOT EXISTS "anime_synonyms"
(
\t"id"       serial  UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_advanced 4'] = '''CREATE TABLE IF NOT EXISTS "anime_fansubbers"
(
\t"id"         serial  UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_advanced 5'] = '''CREATE TABLE IF NOT EXISTS "anime_fandubbers"
(
\t"id"         serial  UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_advanced 6'] = '''CREATE TABLE IF NOT EXISTS "anime_licensors"
(
\t"id"        serial  UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_advanced 7'] = '''CREATE TABLE IF NOT EXISTS "anime_rates_scores_stats_m2m"
(
\t"id"                     serial  UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_advanced 8'] = '''CREATE TABLE IF NOT EXISTS "anime_rates_statuses_stats_m2m"
(
\t"id"                       serial  UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_advanced 9'] = '''CREATE TABLE IF NOT EXISTS "anime_genres_m2m"
(
\t"id"         serial   UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_basic 1'] = '''CREATE TABLE IF NOT EXISTS "poor_anime"
(
\t"id"         serial  UNIQUE PRIMARY KEY NOT NULL,
...
snapshots['test_scheme_basic 2'] = '''CREATE TABLE IF NOT EXISTS "poor_anime_image"
(
\t"id"       serial  UNIQUE PRIMARY KEY NOT NULL,
\t"original" text    NOT NULL,
\t"preview"  text    NOT NULL,
...
snapshots['test_scheme_basic 3'] = '''CREATE TABLE IF NOT EXISTS "poor_anime"
(
\t"id"             integer  UNIQUE PRIMARY KEY NOT NULL,
\t"name"           text     NOT NULL,
\t"russian"        text     NOT NULL,
